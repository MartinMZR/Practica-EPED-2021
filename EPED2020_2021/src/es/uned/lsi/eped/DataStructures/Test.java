...
public class Test {
	  ...
	  public static void main(String [] args) throws Exception{
		...
		System.out.println();
		System.out.println("Tamaï¿½o de la cola: "+queue.size);
		...
		*/
		...
		//obtener posiciï¿½n donde ubicar un nuevo hijo: nï¿½mero de hijos + 1
		...
		//operaciones sobre ï¿½rboles n-ï¿½rios
